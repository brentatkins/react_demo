...
/***/ function(module, exports, __webpack_require__) {
	...
	var _calculator = __webpack_require__(157);

	var _calculator2 = _interopRequireDefault(_calculator);

	_react2['default'].render(_react2['default'].createElement(_calculator2['default'], null), document.body);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _numberinput = __webpack_require__(158);

	var _numberinput2 = _interopRequireDefault(_numberinput);

	var _storesCalculatorstore = __webpack_require__(159);

	var _storesCalculatorstore2 = _interopRequireDefault(_storesCalculatorstore);

	var _actionsCalculatoractions = __webpack_require__(173);
	...
	exports['default'] = _react2['default'].createClass({
	  ...
	  getInitialState: function getInitialState() {
	    return _storesCalculatorstore2['default'].getState();
	  },

	  componentDidMount: function componentDidMount() {
	    _storesCalculatorstore2['default'].listen(this.onChange);
	  },

	  componentWillUnmount: function componentWillUnmount() {
	    _storesCalculatorstore2['default'].unlisten(this.onChange);
	  },
	  ...
	  calculate: function calculate() {
	    var A = parseFloat(this.refs.numberA.getValue());
	    var B = parseFloat(this.refs.numberB.getValue());

	    _actionsCalculatoractions2['default'].calculate({ A: A, B: B });
	  },
	  ...
	  render: function render() {
	    return _react2['default'].createElement(
	      ...
	      _react2['default'].createElement(
	        'h1',
	        null,
	        'Redington Calculator'
	      ),
	      _react2['default'].createElement(_numberinput2['default'], { placeholder: 'value for A', ref: 'numberA' }),
	      _react2['default'].createElement(_numberinput2['default'], { placeholder: 'value for B', ref: 'numberB' }),
	      _react2['default'].createElement('input', { type: 'button', value: 'Post', onClick: this.calculate }),
	      _react2['default'].createElement(
	        'h3',
	        null,
	        'Result'
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = _react2['default'].createClass({
		...
		render: function render() {
			return _react2['default'].createElement('input', { type: 'text', placeholder: this.props.placeholder, value: this.state.value, onChange: this.handleChange });
		}
	});
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CalculatorStore = (function () {
		function CalculatorStore() {
			...
			this.bindListeners({
				calculate: _actionsCalculatoractions2['default'].CALCULATE
			});
		...
		_createClass(CalculatorStore, [{
			key: 'calculate',
			value: function calculate(payload) {
	...
	exports['default'] = _alt2['default'].createStore(CalculatorStore);
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CalculatorActions = function CalculatorActions() {
		_classCallCheck(this, CalculatorActions);

		this.generateActions('calculate');
	};

	exports['default'] = _alt2['default'].createActions(CalculatorActions);
	module.exports = exports['default'];
